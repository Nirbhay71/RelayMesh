            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className="w-full max-w-md bg-[#111116] border border-white/[0.08] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]"
                        ...
                        <div className="p-4 border-b border-white/[0.06]">
                            <div className="relative flex items-center">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/[0.04] border border-white/[0.09] rounded-xl py-2.5 pl-10 pr-10 text-white text-sm placeholder:text-gray-500 focus:outline-none focus:border-indigo-500/50 transition-all font-light"
                                    value={query}
                                            ...
                                            <div className="flex items-center gap-2 flex-shrink-0">
                                                {u.isAlreadyContact ? (
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={isAdding}
                                                        className="text-xs bg-white/10 hover:bg-indigo-600 hover:text-white text-gray-300 px-3 py-1.5 rounded-lg transition-all flex items-center gap-1 font-medium"
                                                    >
                                                ...
                                                <button
                                                    ...
                                                    className="text-xs bg-indigo-600 hover:bg-indigo-500 text-white px-3 py-1.5 rounded-lg shadow-md transition-all flex items-center gap-1 font-medium"
                                                >
